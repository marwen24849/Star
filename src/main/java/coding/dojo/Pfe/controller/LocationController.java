...
public class LocationController {
    ...
    public ResponseEntity<Location> createReservation(@RequestBody ReservationRequest reservationRequest) {
        Location reservation = locationService.createReservation(reservationRequest.getUserId(), reservationRequest.getCarId(), reservationRequest.getStartDate(), reservationRequest.getEndDate());
